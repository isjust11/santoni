  ...
  return (
    <section className="relative w-full min-h-screen py-20 px-6 md:px-12 lg:px-20 bg-brand-dominant flex flex-col justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full z-10">
        ...
        {/* Title Group with Navigation Controls */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          ...
          {/* S7 Carousel navigation buttons */}
        ...
        {/* S7 Horizontal Row Carousel Grid */}
        <div
          ref={scrollRef}
          className="flex gap-6 overflow-x-auto pb-8 snap-x scrollbar-none scroll-smooth -mx-6 px-6 md:-mx-12 md:px-12 lg:-mx-20 lg:px-20"
